...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative inline-flex h-9 w-9 items-center justify-center rounded-full bg-black/5 hover:bg-black/10 dark:bg-white/10 dark:hover:bg-white/20 border border-black/5 dark:border-white/10 transition-colors"
      title="Alternar tema"
    >
